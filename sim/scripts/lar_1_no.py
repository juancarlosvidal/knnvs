...
# def f0(z): return 10
def f0(z): return 5 * np.sum(z[0:7])
...
#    p_list = [3, 5, 10]
    ...
    str_sim = 'lar1-no-fs-[0:7]-[]'
    fa_gt = np.array([0, 1, 2, 3, 4, 5, 6, 7])   # Ground truth of important variables in mean
    ...
    with open('lar1_no.csv', 'w', newline='') as file:
